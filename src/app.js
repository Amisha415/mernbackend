...
const path = require("path"); // importing package provides a way of working with directories and file paths
...
app.get("/register", (req, res) => {
  //get /register route which will render register.hbs file
  res.render("register");
});
app.get("/login", (req, res) => {
  //get /login route which will render login.hbs file
  res.render("login");
});
